...
export default class SettingsPanel extends EtchComponent {
  ...
  resetControls() {
    var el = document.getElementById('go-build-panel-settings');
    if (el) {
  ...
  render() {
    ...
    return <div className='go-panel-content'>
      ...
      <div id='go-build-panel-settings' className='go-build-panel-settings'>
        ...
        <div className='go-build-block'>
          <label for='asm_flags'><input id='asm_flags' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='gccgo_flags'><input id='gccgo_flags' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='gc_flags'><input id='gc_flags' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
          onchange={this.handleInputChange} data-flag='-gcflags' value={gc_flags} />Arguments to pass on each gccgo compiler/linker invocation.</label>
        </div>
        <div className='go-build-block'>
          <label for='install_suffix'><input id='install_suffix' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='ld_flags'><input id='ld_flags' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
          onchange={this.handleInputChange} data-flag='-ldflags' value={ld_flags} />Arguments to pass on each go tool link invocation.</label>
        </div>
        <div className='go-build-block'>
          <label for='link_shared'><input id='link_shared' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='pkg_dir'><input id='pkg_dir' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='tags_flag'><input id='tags_flag' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
        ...
        <div className='go-build-block'>
          <label for='tool_exec'><input id='tool_exec' type='text' className='input-text native-key-bindings' placeholder='' style='width: 50%;'
